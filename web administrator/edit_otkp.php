...
$query = "SELECT * FROM tbotkp WHERE kode_unit = $kode_unit";
...
if (isset($_POST['submit'])){
    ...
    // buat query update
    $query = "UPDATE tbotkp SET kode_unit='$KodeUnit', judul_unit='$judul_unit' WHERE kode_unit=$KodeUnit";
    $sql = mysqli_query($conn, $query);
    ...
    if( $sql ) {
        ...
        header("Refresh:0; url=edit_otkp.php");
    }
...
<head>
  ...
  <title>LSP Skanilan | Edit OTKP</title>
  <!--Logo Title-->
            ...
            <div class="card card-primary">
              ...
              <form method="post" action="">
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-primary" href="otkp.php" role="button">Batal</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
