...
$query = "SELECT * FROM tbasesi WHERE nama_lengkap = $nama_lengkap";
...
if (isset($_POST['update'])){
    ...
    // buat query update
    $query = "UPDATE tbasesi SET nama_lengkap='$NamaLengkap', email='$email', nomor_HP='$no_hp', alamat_rumah='$alamat_rumah', kompetensi_keahlian='$kompetensi_keahlian' WHERE nama_lengkap=$nama_lengkap";
    $sql = mysqli_query($conn, $query);
    ...
    if( $sql ) {
        ...
        header("Refresh:0; url=edit_peserta_asesi.php");
    }
...
<head>
  ...
  <title>LSP Skanilan | Edit Peserta</title>
  <!--Logo Title-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Peserta Asesi </h1><br><br>
          </div>
          <div class="col-sm-6">
              ...
              <form method="post" action="">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="Email" required autocomplete="off"placeholder="Masukkan Email anda" value="<?php echo $data['email']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Nomor HP/WA :</label>
                    <input type="text" class="form-control" name="NomorHP" required autocomplete="off" placeholder="Ketikkan Nomor Anda" value="<?php echo $data['nomor_HP']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Alamat Tinggal :</label>
                    <input type="text" class="form-control" name="AlamatTinggal" required autocomplete="off" placeholder="Ketikkan Alamat Tinggal Anda" value="<?php echo $data['alamat_rumah']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Kompetensi Keahlian/Jurusan :</label>
                    <select name="KompetensiKeahlian" class="form-control" required required autocomplete="off" value="<?php echo $data['kompetensi_keahlian']; ?>">
