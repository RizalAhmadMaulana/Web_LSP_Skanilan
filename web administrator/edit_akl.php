...
$query = "SELECT * FROM tbakl WHERE kode_unit = $kode_unit";
...
if (isset($_POST['submit'])){
    ...
    // buat query update
    $query = "UPDATE tbakl SET kode_unit='$KodeUnit', judul_unit='$judul_unit' WHERE kode_unit=$KodeUnit";
    $sql = mysqli_query($conn, $query);
    ...
    if( $sql ) {
        ...
        header("Refresh:0; url=edit_akl.php");
    }
...
<head>
  ...
  <title>LSP Skanilan | Edit AKL</title>
  <!--Logo Title-->
            ...
            <div class="card card-primary">
              ...
              <form method="post" action="">
                ...
                <div class="card-footer">
                  ...
                  <a class="btn btn-primary" href="akl.php" role="button">Batal</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
