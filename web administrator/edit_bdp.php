...
$query = "SELECT * FROM tbbdp WHERE kode_unit = $kode_unit";
...
if (isset($_POST['submit'])){
    ...
    // buat query update
    $query = "UPDATE tbbdp SET kode_unit='$KodeUnit', judul_unit='$judul_unit' WHERE kode_unit=$KodeUnit";
    $sql = mysqli_query($conn, $query);
    ...
    if( $sql ) {
        ...
        header("Refresh:0; url=edit_bdp.php");
    }
...
<head>
  ...
  <title>LSP Skanilan | Edit BDP</title>
  <!--Logo Title-->
