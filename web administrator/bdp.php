...
if (isset($_GET['kode_unit'])) {
    ...
    // query hapus 
    $query = "DELETE FROM tbbdp WHERE kode_unit=$kode_unit";
                ...
                <table id="datatablesSimple" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href='bdp.php?kode_unit="<?=$data['kode_unit']?>"' class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin untuk mengubah?')">Hapus</a></td>
                            <td><a href='edit_bdp.php?kode_unit="<?=$data['kode_unit']?>"' class="btn btn-warning btn-sm">Edit</a></td>
                        </tr>
                        <?php
                        }
                        ?>
                    </tbody>
                        <a href='create_bdp.php' class="btn btn-secondary"><img src="../gambar/plus.png" width="18px" height="18px">&nbsp;Tambahkan Data</a>&nbsp;&nbsp;<a href='export_bdp.php' class="btn btn-success"><img src="../gambar/export.png" width="18px" height="18px">&nbsp;Export Data</a>&nbsp;&nbsp;<a href='skema_kompetensi.php' class="btn btn-primary">Kembali</a><br><br>
                </table>
              </div>
              <!-- /.card-body -->
            </div>
