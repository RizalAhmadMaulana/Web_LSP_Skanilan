...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tbjadwal (hari, kegiatan, mulai_kegiatan, akhir_kegiatan) VALUES ('$hari', '$nama_kegiatan', '$waktu_mulai', '$waktu_berakhir')";
    ...
    if( $sql ) {
        ...
        header("Refresh:0; url=create_jadwal_kegiatan.php?status=gagal");
    }
...
<head>
  ...
  <title>LSP Skanilan | Rekap Asesor</title>
  <!--Logo Title-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Buat Jadwal Kegiatan </h1><br><br>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col" style="margin-left: 50px; margin-right:100px;">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title" style="color: #E2E2E2; font-family: Thinking Of Betty; font-size: 15px">Form&nbsp;&nbsp;Jadwal&nbsp;&nbsp;Kegiatan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select name="Hari" class="form-control" required required autocomplete="off">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="NamaKegiatan" required autocomplete="off" placeholder="Ketikkan Nama Kegiatan">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Waktu Mulai :</label>
                    <input type="datetime-local" class="form-control"name="WaktuMulai" required autocomplete="off"placeholder="Masukkan Waktu Mulai">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Waktu Berakhir :</label>
                    <input type="datetime-local" class="form-control" name="WaktuBerakhir" required autocomplete="off"placeholder="Masukkan Waktu Berakhir">
                  </div>
                </div>
                <!-- /.card-body -->
