...
if (isset($_GET['nomor_registrasi'])) {
    $nomor_registrasi = $_GET['nomor_registrasi'];

    // query hapus 
    $query = "DELETE FROM tbasesor WHERE nomor_registrasi=$nomor_registrasi";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #E2E2E2; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Rekap&nbsp;&nbsp;Asesor</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="datatablesSimple" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                        $no = 0;
                        $tabel = mysqli_query($conn, "SELECT * FROM tbasesor ORDER BY unit_kompetensi asc");
                        ...
                        <tr>
                            ...
                            <td><a href='rekap_asesor.php?nomor_registrasi="<?=$data['nomor_registrasi']?>"' class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin untuk mengubah?')">Hapus</a></td>
                            <td><a href='edit_asesor.php?nomor_registrasi="<?=$data['nomor_registrasi']?>"' class="btn btn-warning btn-sm">Edit</a></td>
                        </tr>
                        <?php
                        }
                        ?>
        ...
        <a href='export_asesor.php' class="btn btn-secondary" style="margin-left: 10px;"><img src="../gambar/export.png" width="18px" height="18px">&nbsp;Export Data</a>
        <!-- /.row -->
      </div>
      <!-- /.container-fluid -->
    </section>
