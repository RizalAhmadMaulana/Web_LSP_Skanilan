...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tbrpl (kode_unit, judul_unit) VALUES ('$kode_unit', '$judul_unit')";
    ...
    if( $sql ) {
        ...
        header("Refresh:0; url=create_rpl.php?status=gagal");
    }
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Create Skema RPL</h1><br><br><br><br>
          </div>
          <div class="col-sm-6">
