...
$query = "SELECT * FROM tbjadwal WHERE hari = $hari";
...
if (isset($_POST['submit'])){
    ...
    $waktu_berakhir = $_POST['WaktuBerakhir'];

    // buat query update
    $query = "UPDATE tbjadwal SET hari='$Hari', kegiatan='$nama_kegiatan', mulai_kegiatan='$waktu_mulai', akhir_kegiatan='$waktu_berakhir' WHERE hari=$hari";
    $sql = mysqli_query($conn, $query);
    ...
    if( $sql ) {
        ...
        header("Refresh:0; url=edit_jadwal_kegiatan.php");
    }
...
<head>
  ...
  <title>LSP Skanilan | Edit Jadwal</title>
  <!--Logo Title-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit Jadwal Kegiatan </h1><br><br>
          </div>
          <div class="col-sm-6">
              ...
              <form method="post" action="">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <select name="Hari" class="form-control" required required autocomplete="off" value="<?php echo $data['hari']; ?>">
                            <option selected hidden value=""></option>Pilih Hari</option>
                            <option>Senin</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="NamaKegiatan" required autocomplete="off" placeholder="Ketikkan Nama Kegiatan" value="<?php echo $data['kegiatan']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Waktu Mulai :</label>
                    <input type="datetime-local" class="form-control"name="WaktuMulai" required autocomplete="off" placeholder="Masukkan Waktu Mulai" value="<?php echo $data['mulai_kegiatan']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">Waktu Berakhir :</label>
                    <input type="datetime-local" class="form-control" name="WaktuBerakhir" required autocomplete="off" placeholder="Masukkan Waktu Berakhir" value="<?php echo $data['akhir_kegiatan']; ?>">
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-primary">Update</button>&nbsp;&nbsp;
                  <a class="btn btn-primary" href="jadwal_kegiatan.php" role="button">Batal</a>
                </div>
              </form>
            </div>
            <!-- /.card -->
