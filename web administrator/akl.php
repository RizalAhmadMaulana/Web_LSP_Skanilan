...
if (isset($_GET['kode_unit'])) {
    ...
    // query hapus 
    $query = "DELETE FROM tbakl WHERE kode_unit=$kode_unit";
...
<head>
  ...
  <title>LSP Skanilan | Skema AKL</title>
  <!--Logo Title-->
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!--deskripsi-->
    <p style="text-align: justify; margin-left: 20px; margin-right:20px;font-weight:bold;">Skema Sertiifkasi KKNI Level II Pada Kompetensi Keahlian Akuntansi</p>
    <p style="text-align: justify; margin-left: 20px; margin-right:20px; text-indent: 50px;">(Skema Sertifikasi KKNI Level II pada Kompetensi Keahlian Akuntansi, Standar Kompetensi Kerja Nasional Indonesia Kategori Jasa Profesional, Ilmiah dan Teknis Golongan Pokok Jasa Hukum dan Akuntansi Golongan Jasa Akuntansi, Pembukuan dan Pemeriksa; Konsultasi Pajak Sub Golongan Jasa Akuntansi, Pembukuan dan Pemeriksa; Konsultasi Pajak Kelompok Usaha Teknisi Akuntansi,  Keputusan Menteri Tenaga Kerja dan Transmigrasi Republik Indonesia Nomor: 182 Tahun 2013 tanggal 25 Juni 2013 )</p><br>
    <!-- Main content -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #E2E2E2; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Skema&nbsp;&nbsp;AKL</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="datatablesSimple" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                        $no = 0;
                        $tabel = mysqli_query($conn, "SELECT * FROM tbakl ORDER BY judul_unit asc");
                        ...
                        <tr>
                            ...
                            <td><a href='akl.php?kode_unit="<?=$data['kode_unit']?>"' class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin untuk mengubah?')">Hapus</a></td>
                            <td><a href='edit_akl.php?kode_unit="<?=$data['kode_unit']?>"' class="btn btn-warning btn-sm">Edit</a></td>
                        </tr>
                        <?php
                        }
                        ?>
                    </tbody>
                        <a href='create_akl.php' class="btn btn-secondary"><img src="../gambar/plus.png" width="18px" height="18px">&nbsp;Tambahkan Data</a>&nbsp;&nbsp;<a href='export_akl.php' class="btn btn-success"><img src="../gambar/export.png" width="18px" height="18px">&nbsp;Export Data</a>&nbsp;&nbsp;<a href='skema_kompetensi.php' class="btn btn-primary">Kembali</a><br><br>
                </table>
              </div>
              <!-- /.card-body -->
            </div>
