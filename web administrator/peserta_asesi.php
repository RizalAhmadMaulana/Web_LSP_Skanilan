...
if (isset($_GET['nama_lengkap'])) {
    ...
    // query hapus 
    $query = "DELETE FROM tbasesi WHERE nama_lengkap=$nama_lengkap";
...
<head>
  ...
  <title>LSP Skanilan | Rekap Asesi</title>
  <!--Logo Title-->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #E2E2E2; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Peserta&nbsp;&nbsp;Asesi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="datatablesSimple" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        <?php
                        $no = 0;
                        $tabel = mysqli_query($conn, "SELECT * FROM tbasesi ORDER BY kompetensi_keahlian asc");
                        ...
                        <tr>
                            ...
                            <td><a href='peserta_asesi.php?nama_lengkap="<?=$data['nama_lengkap']?>"' class="btn btn-danger btn-sm" onclick="return confirm('apakah anda yakin untuk mengubah?')">Hapus</a></td>
                            <td><a href='edit_peserta_asesi.php?nama_lengkap="<?=$data['nama_lengkap']?>"' class="btn btn-warning btn-sm">Edit</a></td>
                        </tr>
                        <?php
                        }
                        ?>
                    </tbody>
                        <a href='create_peserta_asesi.php' class="btn btn-secondary"><img src="../gambar/plus.png" width="18px" height="18px">&nbsp;Tambahkan Peserta</a>&nbsp;&nbsp;<a href='export_peserta_asesi.php' class="btn btn-success"><img src="../gambar/export.png" width="18px" height="18px">&nbsp;Export Data</a><br><br>
                </table>
              </div>
              <!-- /.card-body -->
            </div>
