        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="rekap_asesi.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Rekap Asesi</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    <!-- Content Header (Page header) -->
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Rekap Asesi</h1><br><br>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php" style="color: #E2E2E2;">dashboard</a></li>
              <li class="breadcrumb-item active"><a href="rekap_asesi.php" style="color: #E2E2E2;">rekap asesi</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #E2E2E2; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Rekap&nbsp;&nbsp;Asesi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
        ...
        <a href='export_asesi.php' class="btn btn-secondary" style="margin-left: 10px;"><img src="../gambar/export.png" width="18px" height="18px">&nbsp;Export Data</a>
        <!-- /.row -->
      </div>
      <!-- /.container-fluid -->
    </section>
