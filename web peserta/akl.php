              ...
              <div class="card-body">
                <table id="datatablesSimple" class="table table-bordered table-hover">
                  ...
                  <tbody>
                        ...
                        <a href='export_akl.php' class="btn btn-success"><img src="../gambar/export.png" width="18px" height="18px">&nbsp;Export Data</a>&nbsp;&nbsp;<a href='skema_kompetensi.php' class="btn btn-primary">Kembali</a><br><br>
                </table>
              </div>
              <!-- /.card-body -->
            </div>
