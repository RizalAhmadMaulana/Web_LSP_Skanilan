...
<head>
  ...
  <title>LSP Skanilan | Export Jadwal</title>
  <!--Logo Title-->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="jadwal_kegiatan.php" style="color: #939393;">Jadwal Kegiatan</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #ADADAD; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Jadwal&nbsp;&nbsp;Kegiatan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
          ...
          <a href='jadwal_kegiatan.php' class="btn btn-primary btn-sm">Tutup</a>
          <!-- /.col -->
        </div>
      </div>
      <!-- /.container-fluid -->
