...
<head>
  ...
  <title>LSP Skanilan | Export Asesi</title>
  <!--Logo Title-->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="rekap_asesi.php" style="color: #939393;">rekap asesi</a></li>
            </ol>
          </div>
        </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #ADADAD; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Rekap&nbsp;&nbsp;Asesi</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
          ...
          <a href='rekap_asesi.php' class="btn btn-primary btn-sm">Tutup</a>
          <!-- /.col -->
        </div>
      </div>
      <!-- /.container-fluid -->
