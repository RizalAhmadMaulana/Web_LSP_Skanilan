...
<head>
  ...
  <title>LSP Skanilan | Export AKL</title>
  <!--Logo Title-->
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"  style="color: #ADADAD; font-family: Thinking Of Betty; font-size: 15px">Tabel&nbsp;&nbsp;Skema&nbsp;&nbsp;AKL</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
          ...
          <a href='akl.php' class="btn btn-primary btn-sm">Tutup</a><br><br>
          <!-- /.col -->
        </div>
      </div>
      <!-- /.container-fluid -->
